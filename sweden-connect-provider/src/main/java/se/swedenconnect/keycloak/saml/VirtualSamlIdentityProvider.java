...
public class VirtualSamlIdentityProvider extends SAMLIdentityProvider {

  public VirtualSamlIdentityProvider(
  ...
  @Override
  public boolean isMapperSupported(final IdentityProviderMapper mapper) {
