...
/**
 * Key Provider Factory for loading a shared RSA-enc key.
 *
 * @author Felix Hellman
 */
public class SharedRSAENCKeyProviderFactory implements KeyProviderFactory {
  private final KeyProviderFactory delegate = new GeneratedRsaEncKeyProviderFactory();
