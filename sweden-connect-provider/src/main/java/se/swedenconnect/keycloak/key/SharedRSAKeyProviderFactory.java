...
/**
 * Key Provider for loading a shared rsa key.
 *
 * @author Felix Hellman
 */
public class SharedRSAKeyProviderFactory implements KeyProviderFactory {

  private final KeyProviderFactory delegate = new GeneratedRsaKeyProviderFactory();
